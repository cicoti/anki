...
public class AnkiMineracao {
	...
	public AnkiMineracao(int baralho) throws InterruptedException, IOException, AWTException {
	...
	public void audioIngles() throws InterruptedException {
